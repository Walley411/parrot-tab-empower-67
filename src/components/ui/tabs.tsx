...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.Trigger
    ...
    className={cn(
      ...
      // Added Teams-specific styling
      "py-4 px-6 border-b-2 border-transparent hover:bg-teams-gray data-[state=active]:border-teams-highlight data-[state=active]:text-teams-text",
      className
    )}
    {...props}
  />
